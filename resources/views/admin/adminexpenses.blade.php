                    ...
                    <div class="bg-white w-full max-w-lg mx-auto rounded-lg shadow-lg p-6">
                        ...
                        <form id="addRoleForm">
                            <div class="mb-4">
                                ...
                                <select name="category" class="w-full px-3 py-2 border rounded focus:outline-none focus:ring focus:border-blue-300" required>
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" name="amount" class="w-full px-3 py-2 border rounded focus:outline-none focus:ring focus:border-blue-300" required>
                            </div>
                            <div class="mb-4">
                                <label class="block text-gray-700 text-sm font-bold mb-2">Entry Date</label>
                                <input type="date" name="date" class="w-full px-3 py-2 border rounded focus:outline-none focus:ring focus:border-blue-300" required>
                            </div>
